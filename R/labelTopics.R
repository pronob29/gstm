#' Label topics
#' 
#' Generate a set of words describing each topic from a fitted gSTM object.
...
#' @param model An \code{gSTM} model object.
...
#' @seealso \code{\link{gstm}} \code{\link{plot.gSTM}} 
