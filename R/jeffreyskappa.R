...
#' Estimation of Kappa (Sparse) Additive Topics
#' 
#' @param beta.ss The beta sufficient statistics matrix.
#' @param kappa A list of kappa parameters.
#' @param settings A list of settings for the estimation process.
#' @return A list containing the estimated beta and updated kappa values.
#' @export
...
#' S3 method for calculating the kappa objective function
#' 
#' @param kappa.param A numeric vector of kappa parameters.
#' @param kappa.other A matrix representing the exp() of other kappa contributions.
#' @param c.k Counts vector for the kappa calculation.
#' @param bigC.k Token counts with appropriate denominator.
#' @param gaussprec The precision vector for the Gaussian penalty.
#' @return A scalar representing the kappa objective function value.
#' @export 
...
#' S3 method for calculating the gradient of the kappa objective function
#' 
#' @param kappa.param A numeric vector of kappa parameters.
#' @param kappa.other A matrix representing the exp() of other kappa contributions.
#' @param c.k Counts vector for the kappa calculation.
#' @param bigC.k Token counts with appropriate denominator.
#' @param gaussprec The precision vector for the Gaussian penalty.
#' @return A numeric vector representing the gradient of the kappa objective function.
#' @export
