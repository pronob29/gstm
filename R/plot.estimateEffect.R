#plot.estimateEffect: Function to plot output from gSTM with respect to
#covariates
...
#' gstm1 <- gstm(out$documents, out$vocab, 3, prevalence=~treatment*binaryvar,
#'  data=gadarian)
#' prep <- estimateEffect(c(2) ~ treatment*binaryvar, gstmobj=gstm1,
#' metadata=gadarian)
#' 
#' par(mfrow=c(1,2))
