#' Prepare documents for analysis with \code{gstm}
#' 
...
#' \item{documents}{The new documents object for use with \code{gstm}}
#' \item{vocab}{The new vocab object for use with \code{gstm}} \item{meta}{The
#' new meta data object for use with \code{gstm}. Will be the same if no
...
prepDocuments <- function(documents, vocab, meta=NULL, 
  ...
  if(!inherits(documents,"list")) {
    stop("documents must be a list in gstm() format.  See ?gstm() for format.  
