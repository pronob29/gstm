...
#' containing a list of documents in \code{\link{gstm}} format, a character vector 
...
#' In general this will be the vocab used in your original gstm model fit which from an gstm
...
#' @return \item{documents}{A list containing the documents in the gstm format.}
