...
#' long as a standard E-step of \code{\link{gstm}} for the same data and
...
#' 
#' @param model An \code{gSTM} object created by \code{\link{gstm}}
...
#' original \code{\link{gstm}} call should be passed here. 
