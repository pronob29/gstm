...
#' Performs model selection across separate gSTM's that each assume different
#' numbers of topics.
#' 
...
#' @param init.type The method of initialization.  See \code{\link{gstm}}.
...
#' the same form as the output from a gstm model.} 
...
#' #This chooses the output, a single run of gSTM that was selected,
