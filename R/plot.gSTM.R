#' Functions for plotting gSTM objects
#' 
#' Produces one of four types of plots for an gSTM object.  The default option
...
#' 
#' The function can produce three types of plots which summarize an gSTM object
...
#' 
#' @param x Model output from gstm.
