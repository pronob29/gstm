#' Group-specific Structural Topic Model
#' 
#' This package implements the Group-specific Structural Topic Model, a general approach to
#' including document-level metadata within mixed-membership topic models. To
#' read the vignette use \code{vignette('gstmVignette')}.
#' 
#' Functions to manipulate documents: \code{\link{textProcessor}}
#' \code{\link{readCorpus}} \code{\link{prepDocuments}}
#' 
#' Functions to fit the model: \code{\link{gstm}} \code{\link{selectModel}}
#' \code{\link{manyTopics}} \code{\link{searchK}}
#' 
#' Functions to summarize a model: \code{\link{labelTopics}}
#' \code{\link{summary.gSTM}} \code{\link{findThoughts}}
#' 
#' Functions for Post-Estimation: \code{\link{estimateEffect}}
#' \code{\link{topicCorr}} \code{\link{permutationTest}}
#' 
#' Plotting Functions: \code{\link{plot.gSTM}} \code{\link{plot.estimateEffect}}
#' \code{\link{plot.topicCorr}} \code{\link{plot.gSTMpermute}}
...
#' @name gstm-package
#' @docType package
#' @author Author: Pronob Kumar Barman
#' 
#' Maintainer: Pronob Kumar Barman <pbarman1@umbc.edu>
#' @seealso \code{\link{gstm}}
...
#' @useDynLib gstm, .registration = TRUE
"_PACKAGE"
...
#' head(poliblog5k.voc)
#' 
#' gstm1 <- gstm(poliblog5k.docs, poliblog5k.voc, 3,
