#' Convert \pkg{gstm} formatted documents to another format
#' 
#' Takes an \pkg{gstm} formatted documents and vocab object and returns formats
...
#' \pkg{gstm} is based on \pkg{lda}'s data representation.  The difference as
#' noted in \code{\link{gstm}} involves how the numbers are indexed.
...
#' 
#' @param documents the documents object in \pkg{gstm} format
#' @param vocab the vocab object in \pkg{gstm} format
