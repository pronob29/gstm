...
#' @param model A fitted gSTM model object.
...
#' number of topics in the gSTM.  } \item{covnames}{ Names of the covariate
#' values used in the gSTM.  } \item{kappa}{Words associated with topics,
