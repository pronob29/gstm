#plotContinuous: function to plot gstm output as a function of a
#continuous variable
...
#model: gstm model (used for labeling)
...
#plotPointEstimate: function to plot gstm output for unique values of a
#variable
#prep: output of plot.estimateEffect
#covariate: covariate of interest
#topics: topics of interest
...
#plotDifference: function to plot gstm output for difference between
