...
#' 
#' @param document a single matrix containing the document in the \code{\link{gstm}} format
...
#' actually just called eta in the output of \code{\link{gstm}} as it is also the point estimate.}
