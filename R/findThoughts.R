...
#' @param model Model object created by \code{gstm}.
...
#' documents which are passed to \code{gstm} and come out of \code{prepDocuments}, 
...
#' sufficient.
#' 
#' @param model The \code{gstm} model.
#' @param meta Optionally, the metadata object passed to the \code{gstm} model.
