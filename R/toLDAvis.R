...
#' 
#' @param mod gSTM object. Output from gstm function.
#' @param docs Documents object passed to \code{gstm} in this package's standard
#' format (see the documentation in \code{\link{gstm}}.
...
#' \donttest{
#' 
#' mod <- gstm(poliblog5k.docs, poliblog5k.voc, K=25,
