...
RcppExport SEXP _gstm_lhoodcpp(SEXP etaSEXP, SEXP betaSEXP, SEXP doc_ctSEXP, SEXP muSEXP, SEXP siginvSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _gstm_gradcpp(SEXP etaSEXP, SEXP betaSEXP, SEXP doc_ctSEXP, SEXP muSEXP, SEXP siginvSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type eta(etaSEXP);
...
RcppExport SEXP _gstm_hpbcpp(SEXP etaSEXP, SEXP betaSEXP, SEXP doc_ctSEXP, SEXP muSEXP, SEXP siginvSEXP, SEXP sigmaentropySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< SEXP >::type eta(etaSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_gstm_lhoodcpp", (DL_FUNC) &_gstm_lhoodcpp, 5},
    {"_gstm_gradcpp", (DL_FUNC) &_gstm_gradcpp, 5},
    {"_gstm_hpbcpp", (DL_FUNC) &_gstm_hpbcpp, 6},
    {NULL, NULL, 0}
};

RcppExport void R_init_gstm(DllInfo *dll) {
